...
import '../TopBar/bookmark_second_top.dart';
...
class BookmarkScreenBodySecond extends StatefulWidget {
  const BookmarkScreenBodySecond({super.key});

  @override
  State<BookmarkScreenBodySecond> createState() => _BookmarkScreenBodySecondState();
}

class _BookmarkScreenBodySecondState extends State<BookmarkScreenBodySecond> {
