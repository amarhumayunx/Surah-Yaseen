...
class VersePageContainerRukuThird extends StatefulWidget {
  ...
  const VersePageContainerRukuThird({
    Key? key,
  ...
  @override
  State<VersePageContainerRukuThird> createState() => _VersePageContainerState();
}

class _VersePageContainerState extends State<VersePageContainerRukuThird> {
  ...
  @override
  void didUpdateWidget(VersePageContainerRukuThird oldWidget) {
                        ...
                        Expanded(
                          child: PageView.builder(
                            ...
                            itemBuilder: (context, pageIndex) {
                              int startIdx = 33 + pageIndex * widget.versesPerPageDialogBox;
