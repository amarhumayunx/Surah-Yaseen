...
import 'VersePageContainerArabicRukuThird.dart';
import 'ruku_third_audio_banner_ad_widget.dart';

class ListenAudioRukuThirdScreen extends StatefulWidget {
  const ListenAudioRukuThirdScreen({super.key});

  @override
  State<ListenAudioRukuThirdScreen> createState() => _ListenAudioScreenState();
}

class _ListenAudioScreenState extends State<ListenAudioRukuThirdScreen> {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  // Verse Container
                  ArabicVerseContainerRukuThird(
                    rukuNumber: 3, // Example ruku number
                    startVerseIndex: 33 + ((_currentPage - 1) * 6), // Calculate start verse based on current page
                    lastVerseIndex: 50, // Last verse index
          ...
          const RukuThirdAudioBannerAdWidget(),
        ],
      ),
    );
  }
