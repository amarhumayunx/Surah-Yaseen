    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          const RukuThirdAudioWithTranslationBannerAdWidget(),
        ],
      ),
    );
  }
