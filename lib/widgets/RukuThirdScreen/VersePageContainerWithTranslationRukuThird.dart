...
class ArabicVerseWithTranslationContainerRukuThird extends StatefulWidget {
  ...
  const ArabicVerseWithTranslationContainerRukuThird({
    Key? key,
  ...
  @override
  State<ArabicVerseWithTranslationContainerRukuThird> createState() => _ArabicVerseWithTranslationContainerState();
}

class _ArabicVerseWithTranslationContainerState extends State<ArabicVerseWithTranslationContainerRukuThird> {
  ...
  @override
  void didUpdateWidget(ArabicVerseWithTranslationContainerRukuThird oldWidget) {
