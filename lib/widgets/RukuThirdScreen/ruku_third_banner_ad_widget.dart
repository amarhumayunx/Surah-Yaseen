...
/// Anchored adaptive banner ad widget for RukuThirdScreen
/// Follows Google Mobile Ads SDK best practices for anchored adaptive banners
class RukuThirdBannerAdWidget extends StatefulWidget {
  const RukuThirdBannerAdWidget({super.key});

  @override
  State<RukuThirdBannerAdWidget> createState() => _RukuThirdBannerAdWidgetState();
}

class _RukuThirdBannerAdWidgetState extends State<RukuThirdBannerAdWidget> {
  BannerAd? _bannerAd;
  ...
  String get _adUnitId {
    ...
    // Production ad unit ID for RukuThirdScreen
    return AdUnitIds.rukuThirdScreenBanner;
  }
