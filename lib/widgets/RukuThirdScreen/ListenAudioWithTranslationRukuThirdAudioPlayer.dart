...
class ListenAudioWithTranslationRukuThirdAudioPlayer extends StatefulWidget {
  final String? title;
  ...
  const ListenAudioWithTranslationRukuThirdAudioPlayer({
    Key? key,
    this.title,
  ...
  @override
  State<ListenAudioWithTranslationRukuThirdAudioPlayer> createState() =>
      _ListenAudioWithTranslationRukuThirdAudioPlayerState();
}

class _ListenAudioWithTranslationRukuThirdAudioPlayerState
    extends State<ListenAudioWithTranslationRukuThirdAudioPlayer>
