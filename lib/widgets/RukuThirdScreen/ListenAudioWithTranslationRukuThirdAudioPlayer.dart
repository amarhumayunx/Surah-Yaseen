...
class ListenAudioWithTranslationRukuThirdAudioPlayer extends StatefulWidget {
  ...
  @override
  State<ListenAudioWithTranslationRukuThirdAudioPlayer> createState() => _AudioPlayerWidgetState();
}

class _AudioPlayerWidgetState extends State<ListenAudioWithTranslationRukuThirdAudioPlayer> {
      ...
      children: [
        ...
        Padding(
          ...
          child: Align(
            ...
            child: Text(
              widget.title ?? AppStrings.listenAudioWithTranslationScreenString.Ruku3title,
              style: TextStyle(
                fontSize: 20,
