...
/// Generic reusable VersePageContainer with Arabic and English translation for audio listening screens
class ArabicVerseWithTranslationContainer extends StatefulWidget {
  ...
  const ArabicVerseWithTranslationContainer({
    super.key,
  ...
  @override
  State<ArabicVerseWithTranslationContainer> createState() =>
      _ArabicVerseWithTranslationContainerState();
}

class _ArabicVerseWithTranslationContainerState
    extends State<ArabicVerseWithTranslationContainer> {
  ...
  @override
  void didUpdateWidget(ArabicVerseWithTranslationContainer oldWidget) {
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          if (index < arabicEntries.length - 1) SizedBox(height: 10),
                        ],
                      ),
                    ),
                  ],
                ...
                child: PageView.builder(
                  ...
                  onPageChanged: (int page) {
                    ...
                    if (newPage != widget.currentPage) {
                      ...
                      if (newPage > widget.currentPage && widget.onNextPage != null) {
                        widget.onNextPage!();
                      } else if (newPage < widget.currentPage && widget.onPrevPage != null) {
                        widget.onPrevPage!();
                      }
                    }
                  },
