...
class ListenAudioWithTranslationRukuFiveAudioPlayer extends StatefulWidget {
  ...
  @override
  State<ListenAudioWithTranslationRukuFiveAudioPlayer> createState() => _AudioPlayerWidgetState();
}

class _AudioPlayerWidgetState extends State<ListenAudioWithTranslationRukuFiveAudioPlayer> {
      ...
      children: [
        ...
        Padding(
          ...
          child: Align(
            ...
            child: Text(
              widget.title ?? AppStrings.listenAudioWithTranslationScreenString.Ruku5title,
              style: TextStyle(
                fontSize: 20,
