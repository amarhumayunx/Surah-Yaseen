...
class ListenAudioWithTranslationRukuFiveAudioPlayer extends StatefulWidget {
  final String? title;
  ...
  const ListenAudioWithTranslationRukuFiveAudioPlayer({
    Key? key,
    this.title,
  ...
  @override
  State<ListenAudioWithTranslationRukuFiveAudioPlayer> createState() =>
      _ListenAudioWithTranslationRukuFiveAudioPlayerState();
}

class _ListenAudioWithTranslationRukuFiveAudioPlayerState
    extends State<ListenAudioWithTranslationRukuFiveAudioPlayer>
