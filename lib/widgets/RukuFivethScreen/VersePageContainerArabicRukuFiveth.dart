...
class ArabicVerseContainerRukuFiveth extends StatefulWidget {
  ...
  const ArabicVerseContainerRukuFiveth({
    Key? key,
  ...
  @override
  State<ArabicVerseContainerRukuFiveth> createState() => _ArabicVerseContainerState();
}

class _ArabicVerseContainerState extends State<ArabicVerseContainerRukuFiveth> {
  ...
  @override
  void didUpdateWidget(ArabicVerseContainerRukuFiveth oldWidget) {
