...
class ListenAudioRukuFivethAudioPlayer extends StatefulWidget {
  final String? title;
  final Map<int, String> verses;
  final int startVerse;
  final int endVerse;

  const ListenAudioRukuFivethAudioPlayer({
    Key? key,
    this.title,
  ...
  @override
  State<ListenAudioRukuFivethAudioPlayer> createState() =>
      _ListenAudioRukuFirstAudioPlayerState();
}

class _ListenAudioRukuFirstAudioPlayerState
    extends State<ListenAudioRukuFivethAudioPlayer>
