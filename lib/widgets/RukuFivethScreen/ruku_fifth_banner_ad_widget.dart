...
/// Anchored adaptive banner ad widget for RukuFifthScreen
/// Follows Google Mobile Ads SDK best practices for anchored adaptive banners
class RukuFifthBannerAdWidget extends StatefulWidget {
  const RukuFifthBannerAdWidget({super.key});

  @override
  State<RukuFifthBannerAdWidget> createState() => _RukuFifthBannerAdWidgetState();
}

class _RukuFifthBannerAdWidgetState extends State<RukuFifthBannerAdWidget> {
  BannerAd? _bannerAd;
  ...
  String get _adUnitId {
    ...
    // Production ad unit ID for RukuFifthScreen
    return AdUnitIds.rukuFifthScreenBanner;
  }
