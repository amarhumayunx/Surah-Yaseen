...
/// Anchored adaptive banner ad widget for RukuFifthReadScreen
/// Follows Google Mobile Ads SDK best practices for anchored adaptive banners
class RukuFifthReadBannerAdWidget extends StatefulWidget {
  const RukuFifthReadBannerAdWidget({super.key});

  @override
  State<RukuFifthReadBannerAdWidget> createState() =>
      _RukuFifthReadBannerAdWidgetState();
}

class _RukuFifthReadBannerAdWidgetState
    extends State<RukuFifthReadBannerAdWidget> {
  BannerAd? _bannerAd;
  ...
  String get _adUnitId {
    ...
    // Production ad unit ID for RukuFifthReadScreen
    return AdUnitIds.rukuFifthReadScreenBanner;
  }
