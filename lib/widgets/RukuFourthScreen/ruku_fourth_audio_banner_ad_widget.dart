...
/// Anchored adaptive banner ad widget for RukuFourthAudioScreen
/// Follows Google Mobile Ads SDK best practices for anchored adaptive banners
class RukuFourthAudioBannerAdWidget extends StatefulWidget {
  const RukuFourthAudioBannerAdWidget({super.key});

  @override
  State<RukuFourthAudioBannerAdWidget> createState() =>
      _RukuFourthAudioBannerAdWidgetState();
}

class _RukuFourthAudioBannerAdWidgetState
    extends State<RukuFourthAudioBannerAdWidget> {
  BannerAd? _bannerAd;
  ...
  String get _adUnitId {
    ...
    // Production ad unit ID for RukuFourthAudioScreen
    return AdUnitIds.rukuFourthAudioScreenBanner;
  }
