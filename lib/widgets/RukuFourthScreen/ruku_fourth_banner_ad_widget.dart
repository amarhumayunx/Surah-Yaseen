...
/// Anchored adaptive banner ad widget for RukuFourthScreen
/// Follows Google Mobile Ads SDK best practices for anchored adaptive banners
class RukuFourthBannerAdWidget extends StatefulWidget {
  const RukuFourthBannerAdWidget({super.key});

  @override
  State<RukuFourthBannerAdWidget> createState() => _RukuFourthBannerAdWidgetState();
}

class _RukuFourthBannerAdWidgetState extends State<RukuFourthBannerAdWidget> {
  BannerAd? _bannerAd;
  ...
  String get _adUnitId {
    ...
    // Production ad unit ID for RukuFourthScreen
    return AdUnitIds.rukuFourthScreenBanner;
  }
