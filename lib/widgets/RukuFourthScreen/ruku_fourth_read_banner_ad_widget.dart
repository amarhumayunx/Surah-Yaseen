...
/// Anchored adaptive banner ad widget for RukuFourthReadScreen
/// Follows Google Mobile Ads SDK best practices for anchored adaptive banners
class RukuFourthReadBannerAdWidget extends StatefulWidget {
  const RukuFourthReadBannerAdWidget({super.key});

  @override
  State<RukuFourthReadBannerAdWidget> createState() =>
      _RukuFourthReadBannerAdWidgetState();
}

class _RukuFourthReadBannerAdWidgetState
    extends State<RukuFourthReadBannerAdWidget> {
  BannerAd? _bannerAd;
  ...
  String get _adUnitId {
    ...
    // Production ad unit ID for RukuFourthReadScreen
    return AdUnitIds.rukuFourthReadScreenBanner;
  }
