...
class VersePageContainerRukuFourth extends StatefulWidget {
  ...
  const VersePageContainerRukuFourth({
    Key? key,
  ...
  @override
  State<VersePageContainerRukuFourth> createState() => _VersePageContainerState();
}

class _VersePageContainerState extends State<VersePageContainerRukuFourth> {
  ...
  @override
  void didUpdateWidget(VersePageContainerRukuFourth oldWidget) {
                        ...
                        Expanded(
                          child: PageView.builder(
                            ...
                            itemBuilder: (context, pageIndex) {
                              int startIdx = 51 + pageIndex * widget.versesPerPageDialogBox;
