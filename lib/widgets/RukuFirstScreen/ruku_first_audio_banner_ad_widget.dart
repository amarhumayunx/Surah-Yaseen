...
/// Anchored adaptive banner ad widget for RukuFirstAudioScreen
/// Follows Google Mobile Ads SDK best practices for anchored adaptive banners
class RukuFirstAudioBannerAdWidget extends StatefulWidget {
  const RukuFirstAudioBannerAdWidget({super.key});

  @override
  State<RukuFirstAudioBannerAdWidget> createState() =>
      _RukuFirstAudioBannerAdWidgetState();
}

class _RukuFirstAudioBannerAdWidgetState
    extends State<RukuFirstAudioBannerAdWidget> {
  BannerAd? _bannerAd;
  ...
  String get _adUnitId {
    ...
    // Production ad unit ID for RukuFirstAudioScreen
    return AdUnitIds.rukuFirstAudioScreenBanner;
  }
