...
/// Anchored adaptive banner ad widget for RukuFirstReadScreen
/// Follows Google Mobile Ads SDK best practices for anchored adaptive banners
class RukuFirstReadBannerAdWidget extends StatefulWidget {
  const RukuFirstReadBannerAdWidget({super.key});

  @override
  State<RukuFirstReadBannerAdWidget> createState() =>
      _RukuFirstReadBannerAdWidgetState();
}

class _RukuFirstReadBannerAdWidgetState
    extends State<RukuFirstReadBannerAdWidget> {
  BannerAd? _bannerAd;
  ...
  String get _adUnitId {
    ...
    // Production ad unit ID for RukuFirstReadScreen
    return AdUnitIds.rukuFirstReadScreenBanner;
  }
