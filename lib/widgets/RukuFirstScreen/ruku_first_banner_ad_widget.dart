...
/// Anchored adaptive banner ad widget for RukuFirstScreen
/// Follows Google Mobile Ads SDK best practices for anchored adaptive banners
class RukuFirstBannerAdWidget extends StatefulWidget {
  const RukuFirstBannerAdWidget({super.key});

  @override
  State<RukuFirstBannerAdWidget> createState() => _RukuFirstBannerAdWidgetState();
}

class _RukuFirstBannerAdWidgetState extends State<RukuFirstBannerAdWidget> {
  BannerAd? _bannerAd;
  ...
  String get _adUnitId {
    ...
    // Production ad unit ID for RukuFirstScreen
    return AdUnitIds.rukuFirstScreenBanner;
  }
