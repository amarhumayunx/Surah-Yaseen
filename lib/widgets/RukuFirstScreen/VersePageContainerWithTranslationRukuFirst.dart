...
class ArabicVerseWithTranslationContainerRukuFirst extends StatefulWidget {
  ...
  const ArabicVerseWithTranslationContainerRukuFirst({
    Key? key,
  ...
  @override
  State<ArabicVerseWithTranslationContainerRukuFirst> createState() => _ArabicVerseWithTranslationContainerState();
}

class _ArabicVerseWithTranslationContainerState extends State<ArabicVerseWithTranslationContainerRukuFirst> {
  ...
  @override
  void didUpdateWidget(ArabicVerseWithTranslationContainerRukuFirst oldWidget) {
