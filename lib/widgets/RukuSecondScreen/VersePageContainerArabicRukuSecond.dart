...
class ArabicVerseContainerRukuSecond extends StatefulWidget {
  ...
  const ArabicVerseContainerRukuSecond({
    Key? key,
  ...
  @override
  State<ArabicVerseContainerRukuSecond> createState() => _ArabicVerseContainerState();
}

class _ArabicVerseContainerState extends State<ArabicVerseContainerRukuSecond> {
  ...
  @override
  void didUpdateWidget(ArabicVerseContainerRukuSecond oldWidget) {
