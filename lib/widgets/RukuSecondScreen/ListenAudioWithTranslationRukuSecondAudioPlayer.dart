...
class ListenAudioWithTranslationRukuSecondAudioPlayer extends StatefulWidget {
  ...
  @override
  State<ListenAudioWithTranslationRukuSecondAudioPlayer> createState() => _AudioPlayerWidgetState();
}

class _AudioPlayerWidgetState extends State<ListenAudioWithTranslationRukuSecondAudioPlayer> {
      ...
      children: [
        ...
        Padding(
          ...
          child: Align(
            ...
            child: Text(
              widget.title ?? AppStrings.listenAudioWithTranslationScreenString.Ruku2title,
              style: TextStyle(
                fontSize: 20,
