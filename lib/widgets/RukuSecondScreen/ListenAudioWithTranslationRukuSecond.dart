...
import 'ruku_second_audio_with_translation_banner_ad_widget.dart';

class ListenAudioWithTranslationRukuSecond extends StatefulWidget {
  const ListenAudioWithTranslationRukuSecond({super.key});

  @override
  State<ListenAudioWithTranslationRukuSecond> createState() => _ListenAudioWithTranslationState();
}

class _ListenAudioWithTranslationState extends State<ListenAudioWithTranslationRukuSecond> {
    ...
    return Scaffold(
      ...
      body: Stack(
          children: [
                ...
                child: Padding(
                  ...
                  child: Column(
                      ...
                      [
                        ...
                        ArabicVerseWithTranslationContainerRukuSecond(
                          rukuNumber: 2,
                          startVerseIndex: 13 + ((_currentPage - 1) * 6),
                          lastVerseIndex: 32,
                          versesPerPage: 6,
            ...
            const RukuSecondAudioWithTranslationBannerAdWidget(),
          ]
      ),
    );
  }
