...
/// Anchored adaptive banner ad widget for RukuSecondAudioScreen
/// Follows Google Mobile Ads SDK best practices for anchored adaptive banners
class RukuSecondAudioBannerAdWidget extends StatefulWidget {
  const RukuSecondAudioBannerAdWidget({super.key});

  @override
  State<RukuSecondAudioBannerAdWidget> createState() =>
      _RukuSecondAudioBannerAdWidgetState();
}

class _RukuSecondAudioBannerAdWidgetState
    extends State<RukuSecondAudioBannerAdWidget> {
  BannerAd? _bannerAd;
  ...
  String get _adUnitId {
    ...
    // Production ad unit ID for RukuSecondAudioScreen
    return AdUnitIds.rukuSecondAudioScreenBanner;
  }
