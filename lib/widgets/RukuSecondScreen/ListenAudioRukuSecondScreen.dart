...
class ListenAudioRukuSecondScreen extends StatefulWidget {
  ...
  @override
  State<ListenAudioRukuSecondScreen> createState() =>
      _ListenAudioRukuSecondScreenState();
}

class _ListenAudioRukuSecondScreenState
    extends State<ListenAudioRukuSecondScreen> {
  ...
  int _activeVerseIndex =
      -1; // Set initial active verse to the first verse (13)
