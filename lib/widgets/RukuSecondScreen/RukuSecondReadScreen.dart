...
import 'package:surah_yaseen/widgets/RukuSecondScreen/VersePageContainerRukuSecond.dart';
import 'package:surah_yaseen/widgets/SurahTitle/surat_title.dart';
import 'package:surah_yaseen/widgets/Topbackground/top_background.dart';
import '../../Colors/colors.dart';
import '../Dividerbar/dividerbar.dart';
import 'ruku_second_read_banner_ad_widget.dart';

class RukuSecondReadScreen extends StatefulWidget {
  const RukuSecondReadScreen({super.key});

  @override
  State<RukuSecondReadScreen> createState() => _ReadScreenState();
}

class _ReadScreenState extends State<RukuSecondReadScreen> {

  final int firstVerseIndex = 12; // verse 13
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
                ...
                children: [
                  ...
                  Expanded(
                    child: Padding(
                      ...
                      child: Center(
                        child: VersePageContainerRukuSecond(
                          rukuNumber: 2, // Updated to Ruku 2
                          startVerseIndex: (_currentPage - 1) * 4 + 13, // 13th verse is index 12
                          lastVerseIndex: 32, // 32nd verse is index 31
                          versesPerPage: 4,
          ...
          const RukuSecondReadBannerAdWidget(),
        ],
      ),
    );
  }
