...
/// Anchored adaptive banner ad widget for RukuSecondScreen
/// Follows Google Mobile Ads SDK best practices for anchored adaptive banners
class RukuSecondBannerAdWidget extends StatefulWidget {
  const RukuSecondBannerAdWidget({super.key});

  @override
  State<RukuSecondBannerAdWidget> createState() => _RukuSecondBannerAdWidgetState();
}

class _RukuSecondBannerAdWidgetState extends State<RukuSecondBannerAdWidget> {
  BannerAd? _bannerAd;
  ...
  String get _adUnitId {
    ...
    // Production ad unit ID for RukuSecondScreen
    return AdUnitIds.rukuSecondScreenBanner;
  }
