...
/// Anchored adaptive banner ad widget for RukuSecondReadScreen
/// Follows Google Mobile Ads SDK best practices for anchored adaptive banners
class RukuSecondReadBannerAdWidget extends StatefulWidget {
  const RukuSecondReadBannerAdWidget({super.key});

  @override
  State<RukuSecondReadBannerAdWidget> createState() =>
      _RukuSecondReadBannerAdWidgetState();
}

class _RukuSecondReadBannerAdWidgetState
    extends State<RukuSecondReadBannerAdWidget> {
  BannerAd? _bannerAd;
  ...
  String get _adUnitId {
    ...
    // Production ad unit ID for RukuSecondReadScreen
    return AdUnitIds.rukuSecondReadScreenBanner;
  }
